...
%prep
%setup -q -n sphinxcontrib_applehelp-2.0.0
cd %{_builddir}/sphinxcontrib_applehelp-2.0.0
pushd ..
cp -a sphinxcontrib_applehelp-2.0.0 buildavx2
popd
pushd ..
cp -a sphinxcontrib_applehelp-2.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722276117
...
cp %{_builddir}/sphinxcontrib_applehelp-%{version}/LICENCE.rst %{buildroot}/usr/share/package-licenses/pypi-sphinxcontrib_applehelp/50d2292390ae54694468ea4c35b53bb06a646e77 || :
