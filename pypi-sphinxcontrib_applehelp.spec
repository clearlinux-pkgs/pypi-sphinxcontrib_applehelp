...
Source0  : https://files.pythonhosted.org/packages/26/6b/68f470fc337ed24043fec987b101f25b35010970bd958970c2ae5990859f/sphinxcontrib_applehelp-1.0.8.tar.gz
...
%prep
%setup -q -n sphinxcontrib_applehelp-1.0.8
cd %{_builddir}/sphinxcontrib_applehelp-1.0.8
pushd ..
cp -a sphinxcontrib_applehelp-1.0.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705166099
