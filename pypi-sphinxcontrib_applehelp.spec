...
Source0  : https://files.pythonhosted.org/packages/e9/05/03f628e210c2ac8f40041f31800f7b6957dd94b845979ba76ee4e1c98f0c/sphinxcontrib_applehelp-1.0.5.tar.gz
...
%prep
%setup -q -n sphinxcontrib_applehelp-1.0.5
cd %{_builddir}/sphinxcontrib_applehelp-1.0.5
pushd ..
cp -a sphinxcontrib_applehelp-1.0.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1691528726
